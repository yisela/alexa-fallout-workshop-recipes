...
/**
 * This Fallout Workshop helper is done based on the Amazon Alexa Skills nodejs skill development kit.
 * The original sample supports multiple languages (en-US, en-GB, de-GB), however the translations are not ready yet.
 * Based on https://github.com/alexa/skill-sample-nodejs-howto
 **/
...
const languageStrings = {
    'en-GB': {
        translation: {
            ...
            SKILL_NAME: 'Fallout Workshop (GB)',
            WELCOME_MESSAGE: "Welcome to %s. You can ask a question like, what\'s the recipe for mentats? ... Now, what can I help you with.",
    ...
    'en-US': {
        translation: {
            ...
            SKILL_NAME: 'Fallout Workshop (US)',
            WELCOME_MESSAGE: "Welcome to %s. You can ask a question like, what\'s the recipe for mentats? ... Now, what can I help you with.",
            WELCOME_REPROMT: 'For instructions on what you can say, please say help me.',
            DISPLAY_CARD_TITLE: '%s  - Recipe for %s.',
            HELP_MESSAGE: "You can ask questions such as, what\'s the recipe, or, you can say exit...Now, what can I help you with?",
    ...
    'de-DE': {
        translation: {
            ...
            SKILL_NAME: 'Fallout Workshop (DE)',
            WELCOME_MESSAGE: 'Willkommen bei %s. Du kannst beispielsweise die Frage stellen: Welche Rezepte gibt es für Mentats? ... Nun, womit kann ich dir helfen?',
